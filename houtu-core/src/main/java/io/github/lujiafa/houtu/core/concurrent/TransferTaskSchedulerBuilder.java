...
/**
 * 委托式 builder：Spring 的 {@link ThreadPoolTaskSchedulerBuilder} 是不可变 builder，
...
public class TransferTaskSchedulerBuilder extends ThreadPoolTaskSchedulerBuilder {
    ...
    private final ThreadPoolTaskSchedulerBuilder delegate;

    public TransferTaskSchedulerBuilder(ThreadPoolTaskSchedulerBuilder delegate) {
