...
/**
 * 委托式 builder：Spring 的 {@link TaskExecutorBuilder} 是不可变 builder，
...
public class TransferTaskExecutorBuilder extends TaskExecutorBuilder {
    ...
    private final TaskExecutorBuilder delegate;

    public TransferTaskExecutorBuilder(TaskExecutorBuilder delegate) {
