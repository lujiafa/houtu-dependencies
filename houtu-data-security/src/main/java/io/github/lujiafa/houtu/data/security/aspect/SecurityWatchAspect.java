...
//    @Pointcut("@within(io.github.lujiafa.annotation.security.data.houtu.SecurityWatch) " +
//            "|| @annotation(io.github.lujiafa.annotation.security.data.houtu.SecurityWatch) " +
//            "|| execution(* (@io.github.lujiafa.annotation.security.data.houtu.SecurityWatch *).*(..)) " +
//            "|| within(@io.github.lujiafa.annotation.security.data.houtu.SecurityWatch *)")
    ...
    Object decryptResult(SecurityContext securityContext, Object result) {
        ...
        if (!getters.isEmpty()) {
            ...
            List<String> decrypts = getters.stream().map(g -> g.get()).toList();
