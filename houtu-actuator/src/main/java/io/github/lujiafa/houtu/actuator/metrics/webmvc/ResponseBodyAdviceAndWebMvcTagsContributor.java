 ...
 */
@ControllerAdvice
public class ResponseBodyAdviceAndWebMvcTagsContributor extends DefaultServerRequestObservationConvention implements ResponseBodyAdvice<Object> {
    ...
    public KeyValues getLowCardinalityKeyValues(ServerRequestObservationContext context) {
        ...
        if (throwable != null) {
            if (throwable instanceof BusinessException) {
                return KeyValues.concat(KeyValues.of("code", String.valueOf(((BusinessException) throwable).getErrorCode().getCode())), keyValues);
            }
            BusinessException businessException = ThrowableUtils.getThrowable(throwable, BusinessException.class);
            if (businessException != null) {
                return KeyValues.concat(KeyValues.of("code", String.valueOf(businessException.getErrorCode().getCode())), keyValues);
            }
        } else {
