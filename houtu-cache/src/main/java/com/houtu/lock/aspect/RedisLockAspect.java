package com.houtu.lock.aspect;

import com.houtu.lock.annotation.Lock;
import com.houtu.lock.support.BLock;
import com.houtu.lock.support.LockSupport;
...
public class RedisLockAspect implements Ordered {
	...
	@Pointcut("@annotation(com.houtu.lock.annotation.Lock)")
